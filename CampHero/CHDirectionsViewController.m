...
@interface CHDirectionsViewController ()
...
@implementation CHDirectionsViewController
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *dirDetailsItem = [[UIBarButtonItem alloc]
                                      initWithTitle:@"Details" style:UIBarButtonItemStylePlain
                                      target:self
