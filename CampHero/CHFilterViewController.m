...
@interface CHFilterViewController ()
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if ([[[CHSearchStore sharedStore] locationName] isEqualToString:@""]) {
        self.locationName = @"You";
    } else {
        self.locationName = [[CHSearchStore sharedStore] locationName];
    }
    [self.tableView reloadData];
    NSIndexPath *selectionIndex = [NSIndexPath indexPathForRow:[[CHSearchStore sharedStore] tribeFilter] inSection:1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.section) {
        ...
        default: {
            ...
            if (indexPath.row == [[CHSearchStore sharedStore] tribeFilter]) {
                cell.selected = YES;
            }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        CHLocationViewController *locationView = [[CHLocationViewController alloc] init];
